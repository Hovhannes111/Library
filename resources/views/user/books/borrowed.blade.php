<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-4 mb-4 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 text-blue-500" role="alert">
                <span class="font-medium">Info alert!</span> Only the administrator can confirm the return of your book.
            </div>    
